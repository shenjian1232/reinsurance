...
import com.minsheng.reinsurance.controller.async.AsyncSendEmail;
...
import com.minsheng.reinsurance.utils.*;
...
public class UserController extends BaseController {
    ...
    public Object getUsersJson(Integer currentPage, Integer pageSize, User user) throws Exception {
        ...
        params = ObjMapConvertUtil.objectToMap(user);
    ...
    public Object add(User user, Integer[] roleIds, Boolean mailNotice) {
        ...
        if (userService.validateUserParams(rtn, user, roleIds)) {
            ...
            user.setSalt(salt);
            user.setPassword(CipherUtil.generatePassword(user.getPassword() + salt));
    ...
    public Object modifyPwd(Integer id, String pwd, String newPwd, String reNewPwd) {
        ...
        if (id != null) {
            ...
            if (user != null) {
                ...
                if (!user.getPassword().equals(CipherUtil.generatePassword(pwd + salt))) {
                    rtn.put("msg", "原密码不正确");
                    return rtn;
                }
                ...
                user.setPassword(CipherUtil.generatePassword(newPwd + salt));
                userService.update(user);
