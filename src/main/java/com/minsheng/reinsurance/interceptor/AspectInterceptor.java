package com.minsheng.reinsurance.interceptor;
...
import com.minsheng.reinsurance.utils.ServletUtil;
...
public class AspectInterceptor {
     ...
     */
    @AfterReturning(pointcut = "execution(public * com.minsheng.reinsurance.controller.manage.HomeController.login(String, String))",
     ...
     * @param returnValue
     */
    @AfterReturning(pointcut = "execution(public * com.mingsheng.reinsurance.controller..*.changeStatus(Integer, Integer))",
            returning = "returnValue")
     ...
     * @param returnValue
     */
    @AfterReturning(pointcut = "execution(public * com.mingsheng.reinsurance.controller..*.update(..))",
            returning = "returnValue")
     ...
     * @param returnValue
     */
    @AfterReturning(pointcut = "execution(public * com.mingsheng.reinsurance.controller..*.insert(..))",
            returning = "returnValue")
     ...
     * @param returnValue
     */
    @AfterReturning(pointcut = "execution(public * com.minsheng.reinsurance.controller..*.delete(Integer))",
            returning = "returnValue")
     ...
     * @param returnValue
     */
    @AfterReturning(pointcut = "execution(public * com.minsheng.reinsurance.controller.manage.UserController.modifyPwd(..))",
            returning = "returnValue")
