...
public class EmailTemplatesUtil {
    ...
    public static String getRegisterTemplate(String loginName, String remarks, String webSite) {
        ...
        sb.append("<html lang=\"zh-cn\">")
                ...
                .append("申请理由是:<br>")
                .append(remarks + "，<br>")
                .append("请速到再保系统<a href=\"" + webSite + "user/index\">(" + webSite + "user/index)</a>进行处理.<br>")
    ...
    public static String getAddUserTemplate(String loginName, String webSite) {
        ...
        sb.append("<html lang=\"zh-cn\">")
                ...
                .append("<tr>")
                .append("<td>")
                .append("&nbsp&nbsp欢迎加入再保系统<br>")
                .append("&nbsp&nbsp当您收到这封信的时候, 您已经可以正常登录了。请点击链接登录首页:")
                .append("&nbsp&nbsp再保系统<a href=\"" + webSite + "\">(" + webSite + ")。</a><br>")
                ...
                .append("&nbsp&nbsp希望您在再保系统度过快乐的时光!<br>")
                .append("</td>")
                .append("</tr>")
                .append("<tr>")
                .append("<td>")
